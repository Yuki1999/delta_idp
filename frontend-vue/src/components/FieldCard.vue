...
<style scoped>
.field-card { background: white; border: 1px solid var(--c-gray-200); border-radius: var(--radius); padding: 16px; transition: box-shadow .15s; }
...
.field-conf { display: inline-flex; align-items: center; gap: 4px; margin-top: 8px; font-size: 11px; padding: 2px 8px; border-radius: 10px; }
